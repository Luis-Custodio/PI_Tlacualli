<div id="carrusel1" class="carousel slide" data-bs-ride="carousel" >
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRd1TV6F79DQaHvrNU60Dx1ansavn0RcZq4FJsyNP_4OQ&s" class="d-block mx-auto" alt="Imagen1" style="max-width: 100%;" width="300px"; height="300px">
        </div>
        <div class="carousel-item">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS11Qfc8mUT-U1lG3dE4FNrwlLNQF80b5j5Q9Pi6x_ulw&s" class="d-block mx-auto" alt="Imagen2" style="max-width: 100%;" width="300px"; height="300px">
        </div>
        <div class="carousel-item">
